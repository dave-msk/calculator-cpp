#ifndef CALCULATOR_CORE_EXPRESSION_BIN_EXPR_TREE_NODES_FUNCTION_FUNCTION_H_
#define CALCULATOR_CORE_EXPRESSION_BIN_EXPR_TREE_NODES_FUNCTION_FUNCTION_H_
#include <string>
...
#endif  // CALCULATOR_CORE_EXPRESSION_BIN_EXPR_TREE_NODES_FUNCTION_FUNCTION_H_
